...
-(void)create:(CDVInvokedUrlCommand *)command
{
  ...
  [self.mapCtrl.executeQueue addOperationWithBlock:^{
    ...
    [createResult setObject:markerId forKey:@"eventId"];

    [[NSOperationQueue mainQueue] addOperationWithBlock:^{
      CDVCommandDelegateImpl *cmdDelegate = (CDVCommandDelegateImpl *)self.commandDelegate;
      [self _create:markerId markerOptions:json callbackBlock:^(BOOL successed, eventId result) {
...
- (void)_create:(NSString *)markerId markerOptions:(NSDictionary *)json callbackBlock:(void (^)(BOOL successed, eventId resultObj)) callbackBlock {
...
-(void)setIcon:(CDVInvokedUrlCommand *)command
{
  ...
  [self.mapCtrl.executeQueue addOperationWithBlock:^{
    ...
    eventId icon = [command.arguments objectAtIndex:1];
    if ([icon isKindOfClass:[NSString class]]) {
...
-(void)setIcon_:(GMSMarker *)marker iconProperty:(NSDictionary *)iconProperty callbackBlock:(void (^)(BOOL successed, eventId resultObj)) callbackBlock {
  ...
  if (image == nil && ![iconPath hasPrefix:@"http"]) {
    ...
    if ([iconPath hasPrefix:@"./"] || [iconPath hasPrefix:@"../"]) {
      ...
      eventId webview = cdvViewController.webView;
