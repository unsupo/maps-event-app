...
-(void)create:(CDVInvokedUrlCommand *)command
{
  ...
  [[NSOperationQueue mainQueue] addOperationWithBlock:^{
      ...
      NSString *eventId = [NSString stringWithFormat:@"polygon_%lu", (unsigned long)polygon.hash];
      [self.mapCtrl.objects setObject:polygon forKey: eventId];
      polygon.title = eventId;
