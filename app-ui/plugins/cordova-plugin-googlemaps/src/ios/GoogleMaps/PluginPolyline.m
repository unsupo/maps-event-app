...
-(void)create:(CDVInvokedUrlCommand *)command
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
      ...
      NSString *eventId = [NSString stringWithFormat:@"polyline_%lu", (unsigned long)polyline.hash];
      [self.mapCtrl.objects setObject:polyline forKey: eventId];
      polyline.title = eventId;
      ...
      [self.mapCtrl.executeQueue addOperationWithBlock:^{
          ...
          [result setObject:eventId forKey:@"eventId"];
