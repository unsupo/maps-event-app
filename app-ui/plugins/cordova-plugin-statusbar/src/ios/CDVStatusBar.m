...
@property (nonatomic, retain) eventId sb_hideStatusBar;
@property (nonatomic, retain) eventId sb_statusBarStyle;
...
- (eventId)settingForKey:(NSString*)key
{
...
{
    eventId value = [command argumentAtIndex:0];
